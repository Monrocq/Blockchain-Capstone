...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, "needs being called by the owner");
        _;
    }
    ...
    event OwnershipTransferred(
        address indexed proprio,
        address indexed acquereur
    );
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(
            newOwner != address(0),
            "The parameter have not point to the zero address"
        );
...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused == false, "The smart-contract is Paused");
        _;
    }

    modifier paused() {
        require(_paused == true, "The smart-contract is not paused");
        _;
    }

    //  5) create a Paused & Unpaused event that emits the address that triggered the event
    event Paused(address indexed emiter);

    event UnPaused(address indexed emiter);
}
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            ...
            "the given address should to not be the owner of the token"
        );
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(
            ...
            "This token already minted or the address is invalid"
        );
    ...
    function _transferFrom(
        ...
        require(
            ...
            "from parameter is not the owner of the token"
        );
        // TODO: require token is being transfered to valid address
        require(to != address(0), "to paramater needs to be valid");
        // TODO: clear approval
